...
public:
	static void CreateUnitBox2D(StandardVertex *&pVerts, int& nverts, TriangleByIndex *&pTriList, int& ntri);
	...
	static void CreateUnitSphereTex(int vslice, int hslice, StandardVertex *& pVerts, int & nverts, TriangleByIndex *& pTriList, int & ntri);
};
